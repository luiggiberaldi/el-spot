    ...
    return (
        <div className="fixed top-4 left-1/2 -translate-x-1/2 z-[400] w-full max-w-sm px-4 animate-in fade-in slide-in-from-top-6 duration-300 pointer-events-auto">
            <button
                ...
                className="bg-slate-900 border border-emerald-500/30 text-white rounded-3xl p-4 shadow-2xl flex items-start gap-3 backdrop-blur-md relative overflow-hidden group cursor-pointer hover:scale-[1.02] active:scale-[0.98] transition-all w-full text-left"
                title="Toca para cerrar"
                aria-label="Cerrar notificación de tasa actualizada"
            >
