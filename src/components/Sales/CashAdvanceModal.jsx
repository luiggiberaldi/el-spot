            ...
            <div className="bg-white dark:bg-slate-900 w-full max-w-md rounded-[24px] shadow-2xl overflow-hidden animate-in slide-in-from-bottom-8 sm:zoom-in-95 duration-200 border border-slate-100 dark:border-slate-800">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                placeholder="0.00"
                                className="w-full py-3.5 px-4 text-center text-3xl font-black bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl text-slate-800 dark:text-white placeholder:text-slate-300 dark:placeholder:text-slate-800 outline-none focus:border-brand focus:ring-4 focus:ring-brand/10 transition-all"
                            />
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    onKeyDown={handleKeyDown}
                                    placeholder="10"
                                    className="w-full py-2.5 px-3 text-center text-lg font-bold bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-slate-800 dark:text-white outline-none focus:border-brand transition-all"
                                />
                    ...
                    {parsedAmount > 0 && (
                        <div className="bg-amber-500/5 dark:bg-amber-500/10 border border-amber-500/15 p-3 rounded-2xl space-y-2 text-xs animate-in fade-in slide-in-from-top-1">
                            ...
                            <div className="flex justify-between items-center border-t border-slate-200/50 dark:border-slate-800/50 pt-2 text-sm">
                                <span className="font-bold text-slate-700 dark:text-slate-300">Cobrarás al cliente:</span>
                ...
                <div className="p-4 bg-slate-50 dark:bg-slate-950/50 border-t border-slate-100 dark:border-slate-800 flex gap-3">
                    <button
                        type="button"
                        onClick={onClose}
                        className="flex-1 py-3 text-center text-xs font-black text-slate-500 dark:text-slate-400 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:bg-slate-50 rounded-xl transition-all"
                    >
                        Cancelar
                    </button>
                    <button
